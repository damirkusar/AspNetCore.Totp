...
namespace AspNetCore.Totp.Tests
{
    public class TotpSetupGeneratorTests
    {
        ...
        public void GenerateSetupCode_shouldNotBeNull_manuelTest_workWithGoogleAuthenticator()
        {
            ...
            Assert.Equal("https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=otpauth%3A%2F%2Ftotp%2FDamirKusar%3Fsecret%3DG5DEMM2GGUZEELJSIJCTCLJUGFCEMLJYGBCEKLJQGRCDGMRRG4YUMOCBGM%26issuer%3DSuper%2520Totp%2520Tester", totpSetup.QrCodeSetupImageUrl);
        }
    }
}
